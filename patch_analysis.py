...
def run_analysis():
    ...
    print("\n=== STATISTISCHE ANALYSE (Kruskal-Wallis H-Test) ===")
...
with open("src/analyze_results.py", "w", encoding="utf-8") as f:
    f.write(code)

print("Analyse-Engine erfolgreich erstellt (src/analyze_results.py)!")
